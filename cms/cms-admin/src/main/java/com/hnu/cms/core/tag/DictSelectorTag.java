...
import com.hnu.cms.modular.system.model.Dict;
import com.hnu.cms.modular.system.service.IDictService;
...
public class DictSelectorTag extends Tag {
    ...
    public void render(){
        ...
        if(ToolUtil.isEmpty(attrs.get("code"))){
            throw new CmsException(BizExceptionEnum.ERROR_CODE_EMPTY);
        }
